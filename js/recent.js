...
$(document).ready(function () {
    ...
    $.ajax({
        url: 'https://api.themoviedb.org/3/movie/latest?api_key=' + apiKey + '&append_to_response=videos,images' //General popular movies
    ...
    .success(function (data) {
        console.log(data);
        $('.hero').append('<img class="backdrop" src="http://image.tmdb.org/t/p/w780/' + data.results[0].backdrop_path + '"/>');
        $('.hero').append('<div class="col-md-12"><div class="col-md-7 intro"><h3>' + data.results[0].title + '</h3><p class="overview">' + data.results[0].overview + '<br/><br/><a class="btn-featured" href="details.html?id=' + data.results[0].id + '">Movie Details</a></p></div><div class="col-md-5 text-right"><a href="details.html?id=' + data.results[0].id + '"><img class=" hero-poster" src="http://image.tmdb.org/t/p/w300/' + data.results[0].poster_path + '"/></a></div></div>')
